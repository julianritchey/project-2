...
def grid_trading_strategy(symbol, start_date, end_date, test_start_date, test_end_date, initial_cash, initial_quantity, quantity, percentage_change, max_grid_count):
    # Download stock data
