...
def grid_trading_strategy(symbol, start_date, end_date, test_start_date, test_end_date, initial_cash= 1000000, initial_quantity= 1000, quantity=50, percentage_change= 0.03, max_grid_count):
    # Download stock data
